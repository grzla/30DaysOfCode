...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    // float meal = meal_cost;
    // float tip = (double) meal * tip_percent/100.0;
    // float tax = (double) meal * tax_percent/100.0;
    // // print the result rounded to the nearest integer
    // printf("%d\n", (int) round(meal + tip + tax));

    // another approach
    // double totalCost = meal_cost * (1 + tip_percent / 100.0 + tax_percent / 100.0);
